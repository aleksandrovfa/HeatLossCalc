...
{
    /// <summary>
    /// Логика взаимодействия для PropertyGridFolderPicker.xaml
    /// </summary>
    public partial class PropertyGridFolderPicker : UserControl , ITypeEditor
    {
        ...
        {
            //InitializeComponent();
            this.LoadViewFromUri("/HeatLossCalc;component/views/propertygridfolderpicker.xaml");
        }
        ...
        public static readonly DependencyProperty ValueProperty =
            DependencyProperty.Register("Value",
                typeof(string),
                typeof(PropertyGridFolderPicker),
